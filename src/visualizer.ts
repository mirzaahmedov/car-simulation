import { Layer, NeuralNetworks } from "./netrork";
import { lerp, getRGBA } from "./utils"

export class Visualizer {
  static drawNetwork(ctx: CanvasRenderingContext2D, network: NeuralNetworks) {
    const margin = 50;
    const left = margin;
    const top = margin;
  ...
  static drawlayer(ctx: CanvasRenderingContext2D, layer: Layer, left: number, top: number, width: number, height: number, outputLabels: any) {
